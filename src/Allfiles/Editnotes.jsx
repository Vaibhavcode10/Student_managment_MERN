...
export default function Editnotes() {
  ...
  // Save updated note to backend using updateNote from context
  const saveChanges = async () => {
    ...
    try {
      await updateNote(subject, activeUnit, editedHtml, editedCode);
    ...
    >
      ...
      {showSidebar && (
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto">className="text-left"
