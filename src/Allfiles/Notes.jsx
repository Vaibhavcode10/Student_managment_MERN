...
export default function Notes() {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`relative rounded-lg shadow-sm px-6 py-6 ${
        ...
        >
          {/* ✏️ Edit Notes button shown always for superadmin */}
          {role === "superadmin" && (
            <div className="absolute top-4 right-4">
              <button
                ...
                className={`flex items-center gap-2 px-3 py-1.5 text-sm font-medium rounded-md border ${
                  theme === "dark"
                    ? "bg-gray-800 border-green-400 text-green-300 hover:bg-gray-700"
          ...
          {note ? (
            <>
              ...
              {note.code && (
                <pre
                  className={`mt-4 px-4 py-3 rounded border overflow-x-auto text-sm font-mono ${
                    theme === "light"
