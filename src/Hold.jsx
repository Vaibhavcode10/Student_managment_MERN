      ...
      {editedUnit || "N/A"}
        ...
        <div className="h-full w-full overflow-hidden pt-[60px] ">
          {mode === "view" ? (
            ...
            <div
              className={`h-full w-full overflow-auto p-6 my-scrollable-div ${
            ...
            <div className="h-full w-full flex relative">
              ...
              <button
                ...
                className={`absolute top-4 right-4 z-10 p-2 rounded-md transition-all duration-200 ${
                  theme === "light"
                    ? "bg-white text-gray-600 hover:bg-gray-100 shadow-md border border-gray-200"
                    : "bg-gray-800 text-gray-300 hover:bg-gray-700 shadow-md border border-gray-600"
                }`}
                title={showCodePanel ? "Hide Code Panel" : "Show Code Panel"}
              >
                <svg 
                  className={`w-4 h-4 transition-transform duration-200 ${showCodePanel ? 'rotate-180' : ''}`}
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
              ...
              {/* Code Block Editor - Side panel (hidden by default) */}
              {showCodePanel && (
                <div
                ...
                >
                  <div
                    className={`px-2 border-b flex items-center justify-between ${
                      theme === "light"
                        ? "bg-gray-100 border-gray-200"
                        : "bg-[#2d2d2d] border-gray-700"
                    }`}
                  >
                    <h6 className="mt-3">code block</h6>
                  </div>
